...
**[Decode-morse-code-message]** is project do decode a morse code  message using Ruby.
...
2. clone with this command `git clone https://github.com/otmanTR/Decode-A-Morse-Code-Message.git
3. cd Decode-A-Morse-Code-Message
...
Feel free to check the [issues page](https://github.com/otmanTR/Decode-A-Morse-Code-Message/issues).
